<?php 
	class Project{
	    ...
	    function delete(){
	        ...
	        $query_del = "DELETE FROM " . $this->table_name . " WHERE projectID = " . $this->project_id."";
	     	$query_sl = "SELECT folderName,imageID FROM " . $this->table_name . " WHERE projectID = " . $this->project_id."";
		    ...
		    //Delete image of this project
		    $query_del_img = "DELETE FROM " . $this->table_name_img . " WHERE imageID = " . $image_id . "";
		    $stmt_del_img = $this->conn->prepare($query_del_img);
   ...
   //   			}
	  ...
	  //       delete_directory($dirname);
	        ...
	        if($stmt_del->execute() && $stmt_del_img->execute()){
	            return true;
	        }
